...
/// <summary>
/// /!!!!!!!!!!!!!!!!!!!!atentie, daca expresia contine o variabila si variabila aia nu are definit un mustloopstmt, loopinfinit
/// </summary>
/// daca anumite non terminale precum expresii, statement-uri folosesc doar o anumita variabila decl, trebuie sa te asiguri ca aceasta va fi cu siguranta generata
/// 

//tu poti pune 2 instante de stmt pe care le-ai vrea cu variabile diferite, dar tu nu stii care sunt varibilele, iti poate face la infinit
//dar, daca pui un singur stmt, care poate contine mascat 2 stmt-uri, atunci va fi aleasa regula potrivita
//gen in loc de print print, pun prints si in prints, doua cout uri alipite
